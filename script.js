...
const data = [
    ...
    new Element("The Tunnel to Summer, the Exit of Goodbye", "Streaming", "Romance - Drame - Science-fiction", "Deuil - Temps - Adolescence", "Deux adolescents découvrent un tunnel mystérieux qui exauce les souhaits mais altère le temps et la réalité."),
    new Element("Les enfants du temps", "Streaming", "Romance - Drame - Fantasy", "Climat - Pouvoirs - Survie", "Un adolescent rencontre une jeune fille capable de contrôler la pluie dans un Tokyo en dérèglement climatique."),
    new Element("5 cm per seconds", "Streaming", "Romance - Drame - Slice of Life", "Distance - Temps - Nostalgie", "Une histoire fragmentée sur l’amour et la séparation au fil des années."),
    new Element("The Garden of Words", "Streaming", "Romance - Drame - Slice of Life", "Pluie - Solitude - Différence d’âge", "Un lycéen et une femme mystérieuse se rencontrent régulièrement dans un jardin pendant les jours de pluie."),
    new Element("Eiga Daisuki Pompo-san", "Streaming", "Comédie - Drame", "Cinéma - Création - Passion", "Un assistant réalisateur ambitieux travaille pour une productrice excentrique dans l’industrie du cinéma."),
    new Element("Ride your wave", "Streaming", "Romance - Drame - Fantastique", "Deuil - Océan - Amour", "Une surfeuse endeuillée continue de voir son compagnon disparu apparaître dans l’eau."),
    new Element("Aura : Koga Maryuin's Last War", "Streaming", "Drame - Psychologique - Slice of Life", "Harcèlement - Imaginaire - École", "Un lycéen victime de harcèlement sombre dans un monde imaginaire pour s’échapper de la réalité."),
    new Element("Suki ni naru sono shunkan wo", "Streaming", "Romance - Drame", "Amour adolescent - Groupe - Confession", "Plusieurs adolescents vivent des histoires d’amour entremêlées et des confessions difficiles."),
    new Element("Hello World", "Streaming", "Romance - Science-fiction - Drame", "Voyage temporel - Réalité simulée - Amour", "Un étudiant rencontre une version future de lui-même pour sauver une fille qu’il aime."),
    new Element("Words bubble up like soda pop", "Netflix", "Romance - Slice of Life", "Communication - Musique - Adolescence", "Deux adolescents timides communiquent à travers la poésie et la musique estivale."),
    new Element("Over the Sky", "Streaming", "Romance - Fantastique - Drame", "Amitié - Monde parallèle - Destin", "Une fille tombe dans un coma et se retrouve dans un monde parallèle entre vie et mort."),
